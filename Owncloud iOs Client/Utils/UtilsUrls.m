...
+ (NSString *) getOwnCloudFilePath {
    ...
    //group.com.owncloud.iOSmobileapp
//    output = [[[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:bundleSecurityGroup] path];
    NSLog(@"%@", [[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:bundleSecurityGroup]);
    //group.com.OoTBDS.iOSmobileapp
//    output = [[[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:@"group.com.owncloud.iOSmobileapp"] absoluteString];
    
    output = [[[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:@"group.com.hlcloud.iOS"] path];
