...
//    self.urlTextField.textColor = [UIColor colorOfURLUserPassword];
    self.urlTextField.textColor = [UIColor colorWithRed:76.0/255.0 green:76.0/255.0 blue:76.0/255.0 alpha:1.0];
    
    //mv
//    self.urlTextField.placeholder = NSLocalizedString(@"url_sample", nil);
    self.urlTextField.text = @"https://client.hlcloud.co.za";
